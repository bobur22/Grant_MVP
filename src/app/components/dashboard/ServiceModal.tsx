...
import { Share2, Star, X } from "lucide-react" // Ensure you have installed the package
            ...
            <div className="flex flex-col lg:flex-row gap-6 mb-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-3">
                  ...
                  <Button className="bg-orange-500 hover:bg-orange-600 text-white">Xizmatlardan foydalanish</Button>
                </div>
              </div>
            </div>
                ...
                <Accordion type="single" collapsible className="space-y-2">
                  <AccordionItem value="price" className="border-white/20">
                    ...
                    <AccordionContent className="text-blue-200 pl-11">
                      Davlat xizmatlari raqamlashtirish dasturi doirasida barcha fuqarolar uchun {serviceDetails.price}
                    </AccordionContent>
                  </AccordionItem>
